...
public class HelloWorld : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else
        {
            ...
            config = SpeechConfig.FromSubscription(Environment.GetEnvironmentVariable("AZURE_SPEECH_API_KEY", EnvironmentVariableTarget.User), Environment.GetEnvironmentVariable("AZURE_SPEECH_API_REGION", EnvironmentVariableTarget.User));
